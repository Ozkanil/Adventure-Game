...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        locations.put(2, new Location(2, "You are at the toop of the hill "));
        locations.put(3, new Location(3, "You are inside of the building, a well house for a small spring"));
        locations.put(4, new Location(4, "You are in a Vallex beside of a stream"));
